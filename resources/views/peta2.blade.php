            ...
            <div class="card-body">
                <div class="row">
                    <select class="form-select alert alert-secondary col-lg-4 col-md-12 col-sm-12 font-weight-bold"
                        ...
                        <option class="text-white" value="0" selected disabled>Pilih Tahun Persebaran</option>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data[1].forEach(element => {
                        console.log(element)
                        // console.log(element.puskesmas.length)
                        ...
                        element.puskesmas.forEach(element => {
                            element.kelurahan.forEach(element => {
                                if (element.kasus !== null) {
                                    ...
                                    if (tahun == element.kasus.tahun) {
                                        // console.log(element.nama)
                                        tSasaran = tSasaran + element.kasus
                                            .sasaran
                                        tJBDdiukur = tJBDdiukur + element.kasus
                                            .j_b_diukur
                                        tSPendek = tSPendek + element.kasus
                                            .s_pendek
                                        tPendek = tPendek + element.kasus.pendek
                                        tNormal = tNormal + element.kasus.normal
                                        tTinggi = tTinggi + element.kasus.tinggi
                                        tTotal = tTotal + element.kasus.total
                                    }
                                }
